                ...
                <table className="tablePostPage">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td colSpan={7}>
                                {accommodation
                                    ? accommodation.address.publicLocationNearby
                                    : ''}
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td colSpan={3}>
                                {accommodation ? accommodation.owner.name : ''}
                            </td>
                            <td className="title">Điện thoại</td>
                            <td colSpan={3}>
                                {accommodation ? accommodation.owner.phone : ''}
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td colSpan={3}>
                                {dateAdded
                                    ? dateAdded
                                          .replace('T00:', ' ')
                                          .substring(0, dateAdded.length - 6)
                                    : ''}
                            </td>
                            ...
                            <td colSpan={3}>
                                {dateExpired
                                    ? dateExpired
                                          .replace('T00:', ' ')
                                          .substring(0, dateExpired.length - 6)
                                    : ''}
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                {accommodation &&
                                    yesOrNo(accommodation.haveClosedBathroom)}
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                {accommodation &&
                                    yesOrNo(accommodation.haveAirConditioner)}
                            </td>
                            <td className="title">Tiện ích khác</td>
                            <td colSpan={3}>
                                {accommodation ? accommodation.roomOptions : ''}
                            </td>
                        </tr>
                        <tr>
